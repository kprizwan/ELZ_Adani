...
module "kubernetes_cluster" {
  ...
  providers = {
    azurerm.keyvault_sub                    = azurerm.dev_env
    azurerm.log_analytics_oms_sub           = azurerm.dev_env
    azurerm.log_analytics_defender_sub      = azurerm.dev_env
    azurerm.kubernetes_cluster_sub          = azurerm.dev_env
    azurerm.private_dns_zone_sub            = azurerm.dev_env
    azurerm.user_assigned_identity_sub      = azurerm.dev_env
    azurerm.ingress_application_gateway_sub = azurerm.dev_env
...
module "source_virtual_network_peering" {
  ...
  providers = {
    azurerm.source_virtual_network_sub      = azurerm.dev_env
...
module "destination_virtual_network_peering" {
  ...
  providers = {
    ...
    azurerm.destination_virtual_network_sub = azurerm.dev_env
  }
...
/*module "private_endpoint" {
  ...
  providers = {
    azurerm.private_connection_sub = azurerm.dev_env
    azurerm.private_dns_zone_sub   = azurerm.dev_env
    azurerm.private_endpoint_sub   = azurerm.dev_env
  }
