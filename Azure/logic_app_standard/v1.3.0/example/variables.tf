...
variable "logic_app_standard_variables" {
  type = map(object({
    ...
    logic_app_standard_site_config = list(object({ #(Optional)
      ...
      site_config_elastic_instance_minimum = number #(Optional) The number of minimum instances for this Logic App Only affects apps on the Premium plan.
      ...
      site_config_pre_warmed_instance_count        = number #(Optional) The number of pre-warmed instances for this Logic App Only affects apps on the Premium plan.
