...
key_vault_access_policy_variables = {
  "key_vault_access_policy_1" = {
    ...
    key_vault_access_resource_name                  = "xxxx@ploceus.com"                                                                                                                                                                              #(Required) Specifies the resource name that needs an access policy to the key vault. Possible values are username, group name, service principal name and application name
...
log_analytics_workspace_variables = {
  "log_analytics_workspace_1" = {
    ...
    log_analytics_workspace_location                               = "eastus2"           #(Required) Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created
...
application_insights_variables = {
  "application_insights_1" = {
    ...
    application_insights_location                                    = "eastus2"           #(Required) Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
    ...
    application_insights_log_analytics_workspace_name                = null                #(Optional) The name of the log analytics workspace
    application_insights_log_analytics_workspace_resource_group_name = null                #(Optional) The resource group name of the log analytics workspace
    ...
    application_insights_key_vault_resource_group_name               = "ploceusrg000003"   #(Required) The name of the resource group in which the keyvault is present.
