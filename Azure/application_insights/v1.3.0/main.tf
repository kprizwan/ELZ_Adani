...
data "azurerm_log_analytics_workspace" "log_analytics_workspace" {
  ...
  for_each            = { for k, v in var.application_insights_variables : k => v if v.application_insights_log_analytics_workspace_name != null }
...
resource "azurerm_application_insights" "application_insights" {
  ...
  workspace_id                          = each.value.application_insights_log_analytics_workspace_name != null ? data.azurerm_log_analytics_workspace.log_analytics_workspace[each.key].id : null
