...
windows_web_app_variables = {
  "windows_web_app_1" = {
    ...
    windows_web_app_auth_settings_v2 = null #Optional block
    ...
    windows_web_app_site_config = {                                           #(Required) A site_config block as defined below.
      ...
      site_config_application_stack   = null #(Optional) A application_stack block as defined below
        ...
        auto_heal_setting_trigger = [{       #(Required) A trigger block as defined below.
          ...
          trigger_status_code = { #(Optional) One or more status_code blocks as defined below.
            "trigger_status_code_1" = {
              ...
              status_code_win32_status_code      = null       #(Optional) The Win32 Status Code of the Request.
            }
          }
        }]
      }]
    ...
    windows_web_app_key_vault_name                      = "ploceuskv000001" #(Optional) The Key vault name. Required for fetching key_vault_id.
    windows_web_app_key_vault_resource_group_name       = "ploceusrg000002" #(Optional) The Key vault RG name. Required for fetching key_vault_id.
...
windows_web_app_sub_subscription_id      = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
windows_web_app_sub_tenant_id            = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
storage_account_sub_subscription_id      = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
storage_account_sub_tenant_id            = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
key_vault_sub_subscription_id            = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
key_vault_sub_tenant_id                  = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
application_insights_sub_subscription_id = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
application_insights_sub_tenant_id       = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
