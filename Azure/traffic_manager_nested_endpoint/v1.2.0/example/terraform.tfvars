...
traffic_manager_profile_variables = {
  ...
  "traffic_manager_profile_2" = {
    traffic_manager_profile_name                   = "ploceustmprofile000002" # (Required) The name of the resource group in which to create the Traffic Manager profile.
    traffic_manager_profile_resource_group_name    = "ploceusrg000001"        # (Required) The name of the Traffic Manager profile. Changing this forces a new resource to be created.
    traffic_manager_profile_traffic_routing_method = "Performance"            # (Required) Specifies the algorithm used to route traffic. Possible values are Geographic, Weighted, Performance, Priority, Subnet and MultiValue.
    traffic_manager_profile_traffic_view_enabled   = true                     # (Optional) Indicates whether Traffic View is enabled for the Traffic Manager profile.
    traffic_manager_profile_status                 = "Enabled"                # (Optional) The status of the profile, can be set to either Enabled or Disabled. Defaults to Enabled.
    traffic_manager_profile_max_return             = 2                        # (Optional) The amount of endpoints to return for DNS queries to this Profile. Possible values range from 1 to 8.
    traffic_manager_profile_dns_config = {                                    # (Required) This block specifies the DNS configuration of the Profile, it supports the fields documented below.
      dns_config_relative_name = "ploceustrafdns000002"                       # (Required) The relative domain name, this is combined with the domain name used by Traffic Manager to form the FQDN which is exported as documented below. Changing this forces a new resource to be created.
      dns_config_ttl           = 2                                            # (Required) The TTL value of the Profile used by Local DNS resolvers and clients.
    }
    traffic_manager_profile_monitor_config = {                             # (Required) This block specifies the Endpoint monitoring configuration for the Profile, it supports the fields documented below.
      monitor_config_protocol                     = "HTTPS"                # (Required) The protocol used by the monitoring checks, supported values are HTTP, HTTPS and TCP.
...
traffic_manager_nested_endpoint_variables = {
  "traffic_manager_nested_endpoint1" = {
    traffic_manager_nested_endpoint_name                                  = "ploceusnestedendpoint000001" # (Required) The name of the External Endpoint. Changing this forces a new resource to be created.
    traffic_manager_nested_endpoint_minimum_child_endpoints               = "3"                           # (Required) This argument specifies the minimum number of endpoints that must be ‘online’ in the child profile in order for the parent profile to direct traffic to any of the endpoints in that child profile. This value must be larger than 0. If min_child_endpoints is less than either minimum_required_child_endpoints_ipv4 or minimum_required_child_endpoints_ipv6, then it won't have any effect.
    traffic_manager_nested_endpoint_weight                                = "150"                         # (Optional) Specifies how much traffic should be distributed to this endpoint, this must be specified for Profiles using the Weighted traffic routing method. Valid values are between 1 and 1000.
    traffic_manager_nested_endpoint_enabled                               = true                          # (Optional) Is the endpoint enabled? Defaults to true.
    traffic_manager_nested_endpoint_endpoint_location                     = "westus2"                     # (Optional) Specifies the Azure location of the Endpoint, this must be specified for Profiles using the Performance routing method.
    traffic_manager_nested_endpoint_minimum_required_child_endpoints_ipv4 = "1"                           # (Optional) This argument specifies the minimum number of IPv4 (DNS record type A) endpoints that must be ‘online’ in the child profile in order for the parent profile to direct traffic to any of the endpoints in that child profile. This argument only applies to Endpoints of type nestedEndpoints and defaults to 1.
    traffic_manager_nested_endpoint_minimum_required_child_endpoints_ipv6 = "2"                           # (Optional) This argument specifies the minimum number of IPv6 (DNS record type AAAA) endpoints that must be ‘online’ in the child profile in order for the parent profile to direct traffic to any of the endpoints in that child profile. This argument only applies to Endpoints of type nestedEndpoints and defaults to 1.
    traffic_manager_nested_endpoint_priority                              = "100"                         # (Optional) Specifies the priority of this Endpoint, this must be specified for Profiles using the Priority traffic routing method. Supports values between 1 and 1000, with no Endpoints sharing the same value. If omitted the value will be computed in order of creation.
    traffic_manager_nested_endpoint_geo_mappings                          = ["WORLD"]                     # (Optional) A list of Geographic Regions used to distribute traffic, such as WORLD, UK or DE. The same location can't be specified in two endpoints.
    traffic_manager_nested_endpoint_custom_header = [{                                                    # (Optional) One or more custom_header blocks as defined below.
    ...
    traffic_manager_nested_endpoint_subnet = [{ # (Optional) One or more subnet blocks as defined below
    ...
    traffic_manager_nested_endpoint_traffic_manager_profile_name                       = "ploceustmprofile000001" # (Required) Name of the Traffic manager profile
    traffic_manager_nested_endpoint_traffic_manager_profile_resource_group_name        = "ploceusrg000001"        # (Required) Resource Group Name Name of the Traffic manager profile
    traffic_manager_nested_endpoint_traffic_manager_nested_profile_name                = "ploceustmprofile000002" # (Required) Name of the Nested Traffic manager profile
    traffic_manager_nested_endpoint_traffic_manager_nested_profile_resource_group_name = "ploceusrg000001"        # (Required) Resource Group Name of the Nested Traffic manager profile
  }
}
