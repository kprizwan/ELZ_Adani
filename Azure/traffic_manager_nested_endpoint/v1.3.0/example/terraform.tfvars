...
traffic_manager_nested_endpoint_variables = {
  "traffic_manager_nested_endpoint1" = {
    ...
    traffic_manager_nested_endpoint_endpoint_location                     = "eastus"                      # (Optional) Specifies the Azure location of the Endpoint, this must be specified for Profiles using the Performance routing method.
