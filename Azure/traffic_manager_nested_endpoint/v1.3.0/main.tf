...
resource "azurerm_traffic_manager_nested_endpoint" "traffic_manager_nested_endpoint" {
  ...
  dynamic "custom_header" {
    for_each = each.value.traffic_manager_nested_endpoint_custom_header != null ? toset(each.value.traffic_manager_nested_endpoint_custom_header) : []
    content {
  ...
  dynamic "subnet" {
    for_each = each.value.traffic_manager_nested_endpoint_subnet != null ? toset(each.value.traffic_manager_nested_endpoint_subnet) : []
    content {
