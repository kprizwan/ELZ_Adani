...
resource "azurerm_log_analytics_workspace" "log_analytics_workspace" {
  ...
  allow_resource_only_permissions    = each.value.log_analytics_workspace_allow_resource_only_permissions
  local_authentication_disabled      = each.value.log_analytics_workspace_local_authentication_disabled
  ...
  data_collection_rule_id            = each.value.log_analytics_workspace_data_collection_rule_id
