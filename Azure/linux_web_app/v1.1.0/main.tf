locals {
  ...
  is_ad_secret_required        = { for k, v in var.linux_web_app_variables : k => v if lookup(v, "linux_web_app_ad_secret_required", false) == true }
...
resource "azurerm_linux_web_app" "linux_web_app" {
  ...
  dynamic "logs" {
    ...
    content {
      ...
      failed_request_tracing  = logs.value.logs_failes_request_tracing
      dynamic "http_logs" {
  ...
  dynamic "auth_settings" {
    ...
    content {
      ...
      default_provider               = auth_settings.value.unauthenticated_client_action == "RedirectToLoginPage" && auth_settings.value.multiple_auth_providers_configured == true ? auth_settings.value.default_auth_provider : null
      ...
      dynamic "active_directory" {
        ...
        content {
          ...
          client_secret              = auth_settings.value.linux_web_app_ad_secret_required == true ? data.azurerm_key_vault_secret.AD_client_secret[each.key].value : null
          allowed_audiences          = active_directory.value.allowed_audiences
          client_secret_setting_name = auth_settings.value.linux_web_app_ad_secret_required == false ? active_directory.value.linux_web_app_ad_client_secret_setting_name : null
        }
      }
  ...
  dynamic "site_config" {
    ...
    content {
      ...
      /* api_management_config_id                      = site_config.value.site_config_api_management_config_id */ # commented because of argument not expected here maybe azurerm bug
      ...
      /* remote_debugging                              = site_config.value.site_config_remote_debugging */ # commented because of argument not expected here maybe azurerm bug
      remote_debugging_version                      = site_config.value.site_config_remote_debugging == true ? site_config.value.site_config_remote_debugging_version : null
        ...
        content {
          ...
          dynamic "headers" {
            ...
            content {
              ...
              x_forwarded_for   = headers.value.x_forworded_for
              x_forwarded_host  = headers.value.x_forworded_host
            }
          }
        }
      }
