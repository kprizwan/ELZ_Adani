...
public_ip_variables = {
  "public_ip_1" = {
    ...
    public_ip_domain_name_label                        = "ploceuspublicip000001a" # (Optional) Label for the Domain Name. Will be used to make up the FQDN. If a domain name label is specified, an A DNS record is created for the public IP in the Microsoft Azure DNS system.
...
lb_variables = {
  "lb1" = {
    ...
    lb_location            = "westus2"         # (Required) Specifies the supported Azure Region where the Load Balancer should be created.
    ...
    lb_sku                 = "Gateway"         #(Optional) The SKU of the Azure Load Balancer. Accepted values are Basic, Standard and Gateway. Defaults to Basic.
...
network_interface_variables = {
  "network_interface_1" = {
    ...
    network_interface_auxiliary_mode                = "Floating"         # (Optional) Specifies the auxiliary mode used to enable network high-performance feature on Network Virtual Appliances (NVAs). Possible values are AcceleratedConnections and Floating.
    network_interface_auxiliary_sku                 = "A1"               # (Optional) Specifies the SKU used for the network high-performance feature on Network Virtual Appliances (NVAs). Possible values are A1, A2, A4 and A8.
