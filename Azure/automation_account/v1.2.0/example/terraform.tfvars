...
resource_group_automation_account_variables = {
  "resource_group_1" = {
...
key_vault_key_variables = {
  "key_vault_key_01" = {
    ...
    key_vault_key_key_opts        = ["decrypt", "encrypt", "sign", "verify", "wrapKey", "unwrapKey"] #(Required) A list of JSON web key operations. Possible values include: decrypt, encrypt, sign, unwrapKey, verify and wrapKey. Please note these values are case sensitive.
...
automation_account_variables = {
  "automation_account_01" = {
    ...
    automation_account_key_vault_resource_group_name           = "ploceusrg000001"       # The key vault resource group name which will have the key vault key for encryption.
...
key_vault_subscription_id              = "xxxxxxxx-xxxxxxxxxx-xxxxxxxxx-xxxxxxxx"
key_vault_tenant_id                    = "xxxxxxxx-xxxxxxxxxx-xxxxxxxxx-xxxxxxx"
automation_account_subscription_id     = "xxxxxxxx-xxxxxxxxxx-xxxxxxxxx-xxxxxxxx"
automation_account_tenant_id           = "xxxxxxxx-xxxxxxxxxx-xxxxxxxxx-xxxxxxx"
user_assigned_identity_subscription_id = "xxxxxxxx-xxxxxxxxxx-xxxxxxxxx-xxxxxxxx"
user_assigned_identity_tenant_id       = "xxxxxxxx-xxxxxxxxxx-xxxxxxxxx-xxxxxxx"