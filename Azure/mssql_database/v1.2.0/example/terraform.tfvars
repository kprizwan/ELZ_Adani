...
mssql_server_variables = {
  "server1" = {
    ...
    mssql_server_location            = "eastus"             # (Required) Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
...
mssql_database_variables = {
  "mssql_database_1" = {
    ...
    mssql_database_threat_detection_policy_required        = true                                     #(Required) Whether a threat_detection_policy is needed or not. Possible values are true and false.
    ...
    mssql_database_long_term_retention_policy_required = true #(Required) Whether a long_term_retention_policy is needed or not. Possible values are true and false.
    ...
    mssql_database_short_term_retention_policy_required = true  #(Required) Whether a short_term_retention_policy is needed or not. Possible values are true and false.
