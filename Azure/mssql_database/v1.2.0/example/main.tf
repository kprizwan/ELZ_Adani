...
module "storage_account" {
  ...
  depends_on                = [module.key_vault, module.storage_account_resource_group, module.key_vault_key]
}

# MSSQL Server
module "mssql_server" {
  source = "../../../mssql_server/v1.2.0"
  providers = {
    azurerm.key_vault_sub     = azurerm.key_vault_sub
...
module "mssql_database" {
  ...
  depends_on               = [module.resource_group, module.mssql_server, module.storage_account]
}