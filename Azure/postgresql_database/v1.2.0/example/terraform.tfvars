...
postgresql_server_variables = {
  "postgresql_server_1" = {
    ...
    postgresql_server_location                             = "westus2"               #(Required) Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
    ...
    postgresql_server_threat_detection_policy = {                                    #(Optional)
      postgresql_server_enable_threat_detection_policy = false                       #(Required) Is the policy enabled?
...
postgresql_database_variables = {
  "postgresql_database_1" = {
    postgresql_database_name                = "ploceuspgdb00001"           #(Required) Specifies the name of the PostgreSQL Database, which needs to be a valid PostgreSQL identifier. Changing this forces a new resource to be created.
    postgresql_database_resource_group_name = "ploceusrg000001"            #(Required) The name of the resource group in which the PostgreSQL Server exists. Changing this forces a new resource to be created.
    postgresql_database_server_name         = "ploceuspg000001"            #(Required) Specifies the name of the PostgreSQL Server. Changing this forces a new resource to be created.
    postgresql_database_charset             = "UTF8"                       #(Required) Specifies the Charset for the PostgreSQL Database, which needs to be a valid PostgreSQL Charset. Changing this forces a new resource to be created.
    postgresql_database_collation           = "English_United States.1252" #(Required) Specifies the Collation for the PostgreSQL Database, which needs to be a valid PostgreSQL Collation. Note that Microsoft uses different notation - en-US instead of en_US. Changing this forces a new resource to be created.
