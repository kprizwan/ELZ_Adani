...
postgresql_database_variables = {
  "postgresql_database_1" = {
    postgresql_database_name                = "ploceuspgdb000001"          #(Required) Specifies the name of the PostgreSQL Database, which needs to be a valid PostgreSQL identifier. Changing this forces a new resource to be created.
