...
subnet_variables = {
  "subnet_1" = {
    ...
    subnet_address_prefixes                               = ["10.0.3.0/26"]                    #(Required) The address prefixes to use for the subnet.
...
bastion_host_variables = {
  bastion_host_1 = {
    bastion_host_virtual_network_name                = "ploceusvnet000001"
    ...
    bastion_host_public_ip_name                      = "ploceuspublicip000001"
    ...
    bastion_host_location                            = "eastus2"                  # Specifies the supported Azure location where the resource exists.
    bastion_host_resource_group_name                 = "ploceusrg000001"          # The name of the resource group in which to create the Bastion Host.
    bastion_host_is_copy_paste_enabled               = true                       # is Copy/Paste feature enabled for the Bastion Host. Defaults to true.
    bastion_host_is_file_copy_enabled                = false                      # Is File Copy feature enabled for the Bastion Host. Defaults to false.
    bastion_host_sku                                 = "Basic"                    # Accepted values are Basic and Standard. Defaults to Basic.
    bastion_host_is_ip_connect_enabled               = false                      # Is IP Connect feature enabled for the Bastion Host. Defaults to false.
    ...
    bastion_host_is_shareable_link_enabled           = false                      # Is Shareable Link feature enabled for the Bastion Host. Defaults to false.
    bastion_host_is_tunneling_enabled                = false                      # Is Tunneling feature enabled for the Bastion Host. Defaults to false.
