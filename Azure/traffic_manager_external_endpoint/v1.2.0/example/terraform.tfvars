...
traffic_manager_external_endpoint_variables = {
  "traffic_manager_external_endpoint1" = {
    ...
    traffic_manager_external_endpoint_target            = "ploceustest000001.westus2.cloudapp.azure.com" # (Required) The FQDN DNS name of the target.
    ...
    traffic_manager_external_endpoint_endpoint_location = "westus2"                                      # (Optional) Specifies the Azure location of the Endpoint, this must be specified for Profiles using the Performance routing method.
