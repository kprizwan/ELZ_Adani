data "azurerm_traffic_manager_profile" "traffic_manager_profile" {
  ...
  name                = each.value.traffic_manager_external_endpoint_traffic_manager_profile_profile_name
  resource_group_name = each.value.traffic_manager_external_endpoint_traffic_manager_profile_profile_resource_group_name
}
