...
traffic_manager_external_endpoint_variables = {
  "traffic_manager_external_endpoint1" = {
    traffic_manager_external_endpoint_name                = "ploceusexternalendpoint000001"
    traffic_manager_external_endpoint_resource_group_name = "ploceusrg000001"
    traffic_manager_external_endpoint_weight              = "150"
    traffic_manager_external_endpoint_enabled             = true
    traffic_manager_external_endpoint_target              = "ploceustest000001.westus2.cloudapp.azure.com"
    traffic_manager_external_endpoint_geo_mappings        = ["WORLD"]
    traffic_manager_external_endpoint_priority            = "100"
    traffic_manager_external_endpoint_endpoint_location   = "westus2"
    traffic_manager_external_endpoint_custom_header = [{
      custom_header_name  = "ploeuscustomheader"
      custom_header_value = "ploceus.com"
    }]
    traffic_manager_external_endpoint_subnet = [{
      subnet_first = "10.0.0.0"
      subnet_last  = "10.0.0.255"
      subnet_scope = "24"
    }]
    traffic_manager_external_endpoint_traffic_manager_profile_profile_name                = "ploceustraf000001"
    traffic_manager_external_endpoint_traffic_manager_profile_profile_resource_group_name = "ploceusrg000001"
  }
}
