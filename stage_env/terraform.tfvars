...
kubernetes_cluster_variables = {
  "aks_1" = {
    ...
    kubernetes_cluster_default_node_pool_pod_subnet_name                               = "sd-common-stage-vnet-01-aks-pod-snet" #(Optional) The name of the Subnet where the pods in the default Node Pool should exist. Changing this forces a new resource to be created.
    ...
    kubernetes_cluster_default_node_pool_subnet_name                         = "sd-common-stage-vnet-01-aks-snet-01" #(Optional) Name of Subnet for assigning default node pool to a subnet . A Route Table must be configured on this Subnet.
