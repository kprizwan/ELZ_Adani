...
kubernetes_cluster_variables = {
  "aks_1" = {
    ...
    kubernetes_cluster_default_node_pool_temporary_name_for_rotation                   = "sdplzmgmtaks-rotation01"                              #(Optional) Specifies the name of the temporary node pool used to cycle the default node pool for VM resizing.
