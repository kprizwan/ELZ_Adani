...
kubernetes_cluster_variables = {
  "aks_1" = {
    ...
    kubernetes_cluster_key_vault_resource_group_name                                   = "sd-plz-management-rg" #(Optional) To be provided for the kubernetes_cluster_key_vault_name  resource group
    ...
    kubernetes_cluster_default_node_pool_pod_subnet_name                               = "sd-plz-management-vnet-elk-snet-01"         #(Optional) The name of the Subnet where the pods in the default Node Pool should exist. Changing this forces a new resource to be created.
    ...
    kubernetes_cluster_default_node_pool_pod_virtual_network_resource_group_name       = "sd-plz-management-vnet"         #(Optional) The name of the resource_group where the pods in the default Node Pool should exist. Changing this forces a new resource to be created.
