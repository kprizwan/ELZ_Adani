...
#Variables for Private IP
variable "private_dns_zone_variable" {
  type = map(object({
    private_dns_zone_name                = string
    private_dns_zone_resource_group_name = string
    private_dns_zone_soa_record = list(object({
...
variable "kubernetes_cluster_variables" {
  type = map(object({
    ...
    kubernetes_cluster_default_node_pool_max_pods                                  = number      #kubelet_disk_type - (Optional) The type of disk used by kubelet. Possible values are OS and Temporary.
