...
nat_gateway_variables = {
  "nat_gateway_1" = {
    ...
    nat_gateway_zones                   = ["2"]                       #(Optional) Specifies a list of Availability Zones in which this NAT Gateway should be located. Changing this forces a new NAT Gateway to be created.
