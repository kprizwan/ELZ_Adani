...
linux_virtual_machine_variables = {
  "linux_virtual_machine_1" = {
    ...
    linux_virtual_machine_network_interface = {                                                #(Required) Map of object for network interface
      "nic1" = {
        network_interface_name                = "sd-plz-palovm1-untrust-nic-01" #(Required)Name of the network interface
        network_interface_resource_group_name = "sd-plz-connectivity-rg-01"  #(Required)Resource group name of network interface
      },
      "nic2" = {
        network_interface_name                = "sd-plz-palovm1-trust-nic-02" #(Required)Name of the network interface
        network_interface_resource_group_name = "sd-plz-connectivity-rg-01"  #(Required)Resource group name of network interface
      },
      "nic3" = {
        network_interface_name                = "sd-plz-palovm1-mgmt-nic-03" #(Required)Name of the network interface
        network_interface_resource_group_name = "sd-plz-connectivity-rg-01"  #(Required)Resource group name of network interface
      }
    }
  ...
  "linux_virtual_machine_2" = {
    ...
    linux_virtual_machine_network_interface = {                                                #(Required) Map of object for network interface
      "nic1" = {
        network_interface_name                = "sd-plz-palovm2-untrust-nic-01" #(Required)Name of the network interface
        network_interface_resource_group_name = "sd-plz-connectivity-rg-01"  #(Required)Resource group name of network interface
      },
      "nic2" = {
        network_interface_name                = "sd-plz-palovm2-trust-nic-02" #(Required)Name of the network interface
        network_interface_resource_group_name = "sd-plz-connectivity-rg-01"  #(Required)Resource group name of network interface
      },
      "nic3" = {
        network_interface_name                = "sd-plz-palovm2-mgmt-nic-01" #(Required)Name of the network interface
        network_interface_resource_group_name = "sd-plz-connectivity-rg-01"  #(Required)Resource group name of network interface
      }
    }
    linux_virtual_machine_is_secret_required                                     = false                           #(Required)Boolean value if secret is required or not
